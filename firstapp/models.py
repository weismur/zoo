...
class Animal(models.Model):
    ...
    area_id = models.ForeignKey('Habitat_area', on_delete=models.CASCADE)
    ration_id = models.ForeignKey('Feeding_ration', on_delete=models.CASCADE)
    caretaker_id = models.ForeignKey('User', on_delete=models.CASCADE,related_name='caretaker_id')
    veterenarian_id = models.ForeignKey('User', on_delete=models.CASCADE,related_name='veterenarian_id')
    objects = models.Manager()
